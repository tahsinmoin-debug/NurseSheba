@extends('layouts.app')
@section('title', 'My Complaints - NurseSheba')
@section('content')
<div class="container py-5">
  <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
    <div>
      <h3 class="fw-bold mb-0"><i class="fas fa-flag me-2 text-danger"></i>My Complaints</h3>
      <p class="text-muted mb-0">Track your filed complaints and view admin responses.</p>
    </div>
    <a href="{{ route('patient.dashboard') }}" class="btn btn-outline-secondary">&larr; Back to Dashboard</a>
  </div>

  {{-- Complaints Filed by Patient --}}
    ...
    <div class="card-body p-0">
      ...
      @else
        <div class="text-center py-5">
          ...
          <p class="text-muted mb-0">You haven't filed any complaints yet.</p>
        </div>
      @endif
    </div>
  </div>
